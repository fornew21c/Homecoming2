...
- **[`docs/HANDOFF-2026-08-28-capture.md`](docs/HANDOFF-2026-08-28-capture.md)** —
  **여기서 시작한다.** 캡처에서 경로 채우기(입력 25번 → 1번), 기둥번호가
  캡처에 찍혀 있다, 지하철역을 먼저 보면 버스 기둥이 엉뚱한 역에 걸린다
- **[`docs/HANDOFF-2026-08-28.md`](docs/HANDOFF-2026-08-28.md)** — 그날 앞 회차.
  한 구간에 버스 노선 여럿, 칩이 5분 사라진 원인,
  로컬 서버가 앱 자격을 끊는 함정
